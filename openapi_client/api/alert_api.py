...
class AlertApi(object):
    ...
    def api_web_alert_controller_index(self, **kwargs):  # noqa: E501
        """api_web_alert_controller_index  # noqa: E501
        ...
        >>> thread = api.api_web_alert_controller_index(async_req=True)
        >>> result = thread.get()
        ...
        :param str fields_alert: Fields to include with the response. Multiple fields **MUST** be a comma-separated (U+002C COMMA, \",\") list.  Note that fields can also be selected for included data types: see the [V3 API Best Practices](https://www.mbta.com/developers/v3-api/best-practices) for an example. 
        ...
        :param str filter_severity: Filters alerts by list of severities. **MUST** be a comma-separated (U+002C COMMA, \",\") list.  Example: filter[severity]=3,4,10 returns alerts with severity levels 3, 4 and 10. 
    ...
    def api_web_alert_controller_index_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_web_alert_controller_index_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(Alerts, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['page_offset', 'page_limit', 'sort', 'fields_alert', 'include', 'filter_activity', 'filter_route_type', 'filter_direction_id', 'filter_route', 'filter_stop', 'filter_trip', 'filter_facility', 'filter_id', 'filter_banner', 'filter_datetime', 'filter_lifecycle', 'filter_severity']  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'page_offset' in local_var_params and local_var_params['page_offset'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_offset` when calling `api_web_alert_controller_index`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and 'page_limit' in local_var_params and local_var_params['page_limit'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `page_limit` when calling `api_web_alert_controller_index`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        if 'fields_alert' in local_var_params and local_var_params['fields_alert'] is not None:  # noqa: E501
            query_params.append(('fields[alert]', local_var_params['fields_alert']))  # noqa: E501
        if 'include' in local_var_params and local_var_params['include'] is not None:  # noqa: E501
            query_params.append(('include', local_var_params['include']))  # noqa: E501
        if 'filter_activity' in local_var_params and local_var_params['filter_activity'] is not None:  # noqa: E501
            query_params.append(('filter[activity]', local_var_params['filter_activity']))  # noqa: E501
        ...
        if 'filter_facility' in local_var_params and local_var_params['filter_facility'] is not None:  # noqa: E501
            query_params.append(('filter[facility]', local_var_params['filter_facility']))  # noqa: E501
        ...
        if 'filter_banner' in local_var_params and local_var_params['filter_banner'] is not None:  # noqa: E501
            query_params.append(('filter[banner]', local_var_params['filter_banner']))  # noqa: E501
        if 'filter_datetime' in local_var_params and local_var_params['filter_datetime'] is not None:  # noqa: E501
            query_params.append(('filter[datetime]', local_var_params['filter_datetime']))  # noqa: E501
        if 'filter_lifecycle' in local_var_params and local_var_params['filter_lifecycle'] is not None:  # noqa: E501
            query_params.append(('filter[lifecycle]', local_var_params['filter_lifecycle']))  # noqa: E501
    ...
    def api_web_alert_controller_show(self, id, **kwargs):  # noqa: E501
        """api_web_alert_controller_show  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_web_alert_controller_show(id, async_req=True)
        >>> result = thread.get()
    ...
    def api_web_alert_controller_show_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_web_alert_controller_show_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'fields_alert', 'include']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `api_web_alert_controller_show`")  # noqa: E501
