...
class StopResourceAttributes(object):
    ...
    def __init__(self, wheelchair_boarding=None, name=None, longitude=None, location_type=None, latitude=None, local_vars_configuration=None):  # noqa: E501
        """StopResourceAttributes - a model defined in OpenAPI"""  # noqa: E501
